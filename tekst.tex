...
\subsection{Tree-object} \label{sec:tree_obj}
\subsection{TreeNode-object} \label{sec:treenode_obj}
...
Als er \lstinline{null} in deze sleutel staat, betekend het dat de node geen childnodes heeft. Dan moet staat er ook een prijs gecodeerd in de sleutel \lstinline[language=JavaScript]{"name"}.
